              ...
              <div className="card" id="card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    project User will paste the Long URL and the it will genrate
                    the Short URL after clicked the Short URL button.and that
                    genrated URL wil redirects to the Long URL page.
                  </p>
              ...
              <div className="card" id="card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    string then it will redirects to the reset-password page and
                    there user will able to reset their password
                  </p>
                  <ul className="technologyused">
                    <li>HTML</li>
                    <li>CSS</li>
              ...
              <div className="card" id="card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    ...
                    create users update users and also delete users and same for
                    Products. And I am storing the data onto Mock Api.
                  </p>
                  <ul className="technologyused">
                    <li>HTML</li>
                    <li>CSS</li>
            ...
            <div className="col-lg-4 mx-my-2">
              <div className="card" id="card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    {" "}
                    This is a basic FrontEnd project.In this project I have used
                    the weather Rest Api and display the Population,Region and
                    weather information of all the countries.
                  </p>
                  <ul className="technologyused">
                    <li>HTML</li>
                    <li>CSS</li>
